...
const Post = () => (
  <Layout title="mode.tokyo">
    <Container>
      ...
      <PostImage src="/images/works/modetokyo_eyecatch.png" alt="mode.tokyo" />
      <SimpleGrid columns={2} gap={2}>
        <PostImage src="/images/works/modetokyo_01.png" alt="mode.tokyo" />
        <PostImage src="/images/works/modetokyo_02.png" alt="mode.tokyo" />
      </SimpleGrid>
      <PostImage src="/images/works/modetokyo_03.jpg" alt="mode.tokyo" />
    </Container>
  </Layout>
)
